...
import { loadZodSchemas } from "../../src/loader";
import { LoadedZodSchema } from "../../src/types/LoadedZodSchema.type";
...
describe("loadSchemas", () => {
    ...
    it("should return an error for an invalid filePath", async () => {
        ...
        const hasError = loadedSchemas.some(schema => schema.type === "LoadedZodSchemaError");
