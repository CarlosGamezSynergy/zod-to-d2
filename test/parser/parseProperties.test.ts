...
import { parentOneSchema, schemaWithoutTableName } from "../schema.fixtures";
...
describe("Parsing Tests", () => {
  describe("Basic Parsing", () => {
    ...
    it("should assign unknown_table name if no tableName is provided", () => {
      const props = parseProperties(schemaWithoutTableName);
    ...
    it("should override unknown_table name with provided propertyName", () => {
      const props = parseProperties(schemaWithoutTableName, "custom_table");
      expect(props).toHaveLength(4);
